...
RSpec.describe Signage do # rubocop:disable Metrics/BlockLength
  ...
  it 'outputs different day and time information for store open hours sign even if days are not sorted' do
    list = []
    list << Day.new('Tuesday', '3:00', '4:00')
    list << Day.new('Monday', '2:00', '5:00')
    list << Day.new('Thursday', '2:00', '4:00')
